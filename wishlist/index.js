...
class Product {
    constructor(name, brand, category, price, image) {
...
function getValues() {
    ...
    return { nameVal, brandVal, categoryVal, priceVal, imageVal }
}
...
function addProduct(name, brand, category, price, image) {
    let newProduct = new Product(name, brand, category, price, image)
...
saveChangesBtn.addEventListener("click", (e) => {
    e.preventDefault()
    let { nameVal, brandVal, categoryVal, priceVal, imageVal } = getValues()
    addProduct(nameVal, brandVal, categoryVal, priceVal, imageVal)
    renderProducts(products)
    resetForm()
})
